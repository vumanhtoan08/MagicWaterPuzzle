Shader "IKAME/Particles/Blend_CenterGlow" {
	Properties {
		...
		[Toggle] _UseAGlow ("Use alpha glow?", Float) = 1
		[Enum(UnityEngine.Rendering.CompareFunction)] _ZTest ("ZTest", Float) = 4
		[Toggle] _CustomUVOffset ("CustomUVOffset", Float) = 0
		_DissovleSmooth ("DissovleSmooth", Float) = 0
		[Toggle] _SoftParticle ("SoftParticle", Float) = 0
		_SoftPosition ("SoftPosition", Vector) = (0,0,0,0)
